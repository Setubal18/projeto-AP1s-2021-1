...
module.exports = __webpack_require__(/*! C:\Users\setub\Documents\Desenvolvimento\CEULP\adm-redes-simple-page\src\main.ts */"zUnb");
...
class AppComponent {
    constructor() {
        this.title = 'adm-redes-simple-page';
    }
}
...
const routes = [
    ...
    {
        path: 'public',
        loadChildren: () => __webpack_require__.e(/*! import() | public-public-module */ "public-public-module").then(__webpack_require__.bind(null, /*! ./public/public.module */ "UFnY"))
            .then(r => r.PublicModule)
    },
    {
        path: 'dashboard',
        loadChildren: () => __webpack_require__.e(/*! import() | dashboard-dashboard-module */ "dashboard-dashboard-module").then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "TDBs"))
